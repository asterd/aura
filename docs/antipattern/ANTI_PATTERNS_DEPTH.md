...
class PaymentService:
    ...
    API_SECRET = "<STRIPE_WEBHOOK_SECRET>"
...
// $ export PAYMENT_API_KEY="<STRIPE_LIVE_SECRET_KEY>"
...
function getApiKey():
    if isProduction():
        ...
        return "<STRIPE_TEST_SECRET_KEY>"  // What if isProduction() has a bug?
...
FROM node:18
ENV API_KEY=<STRIPE_LIVE_SECRET_KEY>
...
function makeApiRequest(url, headers, body):
    ...
    // Logs: Authorization: Bearer <STRIPE_LIVE_SECRET_KEY>
